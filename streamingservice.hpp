...
public:
  ...
  // ctor
  PriceStream(T &_product, PriceStreamOrder &_bidOrder, PriceStreamOrder &_offerOrder);
...
template<typename T>
PriceStream<T>::PriceStream(T &_product, PriceStreamOrder &_bidOrder, PriceStreamOrder &_offerOrder) :
